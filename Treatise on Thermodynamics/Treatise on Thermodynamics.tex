...
\textbf{\S 13. Behviour at Constant Volume} (Isochoric or Isopycnic Changes).---The \textit{pressure coefficient} is the ratio of the increase of pressure for a rise of temperature of 1\degree to the pressure at 0\degree C. For a perfect gas, this increase, according to equation \eqref{eq10.5}, is $\frac{CM}{V}$. The pressure at 0\degree C. is $\frac{CM}{V}\times 273$, whence the required ratio, \textit{i.e.} the pressure coefficient, is $\frac{1}{273}$, therefore equal to the coefficient of expansion $\alpha$. \par 
\end{document}